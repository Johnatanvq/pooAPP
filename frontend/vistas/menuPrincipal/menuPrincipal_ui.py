...
class Ui_Menu_Principal(object):
    def setupUi(self, Menu_Principal):
        ...
        Menu_Principal.resize(1001, 589)
...
"    font: 12pt \"Arial\";\n"
"}")
        self.lb_indicador_mreservas_3.setPixmap(QPixmap(u":/newPrefix/home.svg"))
...
"}")
        ...
        self.gridLayout.addWidget(self.cabecera_widget, 2, 0, 1, 2)
...
"")
        ...
        self.bt_cerrarlistado_mm.setIcon(icon7)
        self.bt_cerrarlistado_mm.setIconSize(QSize(40, 40))
        self.bt_cerrarlistado_mm.setCheckable(True)

        self.gridLayout.addWidget(self.bt_cerrarlistado_mm, 0, 2, 1, 1)
        ...
        self.bt_cerrarlistado_mm.toggled.connect(self.widget.setHidden)
        self.bt_cerrarlistado_mm.toggled.connect(self.widget_2.setVisible)
    ...
    def retranslateUi(self, Menu_Principal):
        ...
        self.bt_reservas__mm.setText(QCoreApplication.translate("Menu_Principal", u"Reservas", None))
        ...
        self.lb_indicador_mreservas_2.setText(QCoreApplication.translate("Menu_Principal", u"PRINCIPAL", None))
