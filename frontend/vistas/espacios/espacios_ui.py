...
"")
        ...
        self.frame_ingreso.setGeometry(QRect(10, 220, 441, 171))
...
"")
        ...
        self.layoutWidget_8.setGeometry(QRect(10, 20, 261, 141))
...
"}")
        ...
        self.crear_bt_usuario.setGeometry(QRect(360, 10, 75, 23))
...
"}")
        icon1 = QIcon()
        icon1.addFile(u":/newPrefix/key.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        self.crear_bt_usuario_3.setGeometry(QRect(360, 40, 75, 23))
...
"}")
        ...
        self.error_label_contrasena.setGeometry(QRect(280, 90, 141, 31))
...
"}")
        ...
        self.error_label_correo.setGeometry(QRect(280, 120, 141, 20))
...
"}")
        ...
        self.error_campo_vacio.setGeometry(QRect(280, 70, 141, 20))
...
"}")
        ...
        self.layoutWidget_7.setGeometry(QRect(330, 10, 132, 26))
...
"}")
        ...
        self.lineEdit.setGeometry(QRect(130, 70, 241, 20))
...
"")
        ...
        self.crear_bt_usuario_2.setGeometry(QRect(370, 70, 75, 23))
...
"")
        icon3 = QIcon()
        icon3.addFile(u":/newPrefix/log-out.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.bt_logout_mm.setIcon(icon3)
...
"")
        icon4 = QIcon()
        icon4.addFile(u":/newPrefix/home.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.bt_home_mm.setIcon(icon4)
...
"}")
        icon5 = QIcon()
        icon5.addFile(u":/newPrefix/bookmark.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.bt_reservas__mm.setIcon(icon5)
...
"}")
        icon6 = QIcon()
        icon6.addFile(u":/newPrefix/book-open.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.bt_misreservas_mm.setIcon(icon6)
...
"}")
        icon7 = QIcon()
        icon7.addFile(u":/newPrefix/settings.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.bt_configuraciones_mm.setIcon(icon7)
...
"}")
        icon8 = QIcon()
        icon8.addFile(u":/newPrefix/users.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.bt_usuarios_mm.setIcon(icon8)
...
"    font: 12pt \"Arial\";\n"
"}")
        self.bt_espacios_mm.setIcon(icon1)
...
"}")
        icon9 = QIcon()
        icon9.addFile(u":/newPrefix/shopping-bag.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.bt_utilera_mm.setIcon(icon9)
...
"}\n"
"")
        self.bt_icono_logout_mm.setIcon(icon3)
...
"}\n"
"")
        self.bt_icono_home_mm.setIcon(icon4)
...
"}\n"
"")
        self.bt_icono_reservas_mm.setIcon(icon5)
...
"}\n"
"")
        self.bt_icono_misreservas_mm.setIcon(icon6)
...
"}\n"
"")
        self.bt_icono_configuraciones_mm.setIcon(icon7)
...
"}\n"
"")
        self.bt_icono_usuarios_mm.setIcon(icon8)
...
"}\n"
"")
        self.bt_icono_espacios_mm.setIcon(icon1)
...
"}\n"
"")
        self.bt_icono_utileria_mm.setIcon(icon9)
...
"")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.error_campo_vacio.setText(QCoreApplication.translate("MainWindow", u"error campo vacio", None))
