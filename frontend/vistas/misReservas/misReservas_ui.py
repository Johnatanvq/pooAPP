...
################################################################################
## Form generated from reading UI file 'misReservas.ui'
##
...
"")
        ...
        self.cuadroresumen_misreservas = QTableWidget(self.main_menu)
        if (self.cuadroresumen_misreservas.columnCount() < 4):
            self.cuadroresumen_misreservas.setColumnCount(4)
        if (self.cuadroresumen_misreservas.rowCount() < 10):
            self.cuadroresumen_misreservas.setRowCount(10)
        self.cuadroresumen_misreservas.setObjectName(u"cuadroresumen_misreservas")
        self.cuadroresumen_misreservas.setGeometry(QRect(20, 90, 421, 321))
        self.cuadroresumen_misreservas.setRowCount(10)
        self.cuadroresumen_misreservas.setColumnCount(4)
        self.layoutWidget_7 = QWidget(self.main_menu)
        self.layoutWidget_7.setObjectName(u"layoutWidget_7")
        self.layoutWidget_7.setGeometry(QRect(300, 10, 179, 26))
