...
"}")
        icon11 = QIcon()
        icon11.addFile(u":/newPrefix/shopping-bag.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.bt_utilera_mm.setIcon(icon11)
...
"}\n"
"")
        self.bt_icono_utileria_mm.setIcon(icon11)
